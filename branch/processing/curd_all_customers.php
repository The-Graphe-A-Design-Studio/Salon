            ...
            foreach($result as $row)
            {
                ...
                '
                    <tr>
                        ...
                        <td data-column="#" class="d-flex justify-content-center align-items-center" style="gap: 1rem;">
                            ...
                            <a class="btn btn-icon btn-warning" href="edit_customer?cust_id='.$row['cust_id'].'"><i class="fas fa-edit"></i></a>
                        </td>
                    <tr>
                ';            
            }
