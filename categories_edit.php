<?php
    ...
    $category = "select * from categories where s_id = '$cat'";
        ...
        <div class="main-content">
            <section class="section">
                <div class="section-header">
                    <h1>Services <span style="font-size: 0.6em; margin-left: 10px;">Add / Edit / Delete</span></h1>
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="dashboard">Dashboard</a></div>
                        <div class="breadcrumb-item active"><a href="categories">Categories</a></div>
                                                        ...
                                                        <div class="table-responsive my-table-responsive">
                                                            <table class="table" id="mytable">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="edit_service_<?php echo $i; ?>" value="<?php echo $row_get['se_name']; ?>">
                                                                            <input type="text" name="edit_service_id_<?php echo $i; ?>" value="<?php echo $row_get['se_id']; ?>" hidden>
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                                $i++;
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive my-table-responsive">
                                                        <table class="table" id="mytable">
                                                            <tbody>
                                                                <?php
                                                                    $gets = "select * from services where s_id = '$cat' order by se_name";
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <form class="edit_cat">
                                                                            ...
                                                                            <input type="text" name="delete_service_id" value="<?php echo $row_gets['se_id']; ?>" hidden>
