<?php
    ...
    $branch = "select * from locations where l_id = '$loc'";
        ...
        <div class="main-content">
            <section class="section">
                <div class="section-header">
                    <h1>Staffs <span style="font-size: 0.6em; margin-left: 10px;">Add / Edit Details / Remove</span></h1>
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="dashboard">Dashboard</a></div>
                        <div class="breadcrumb-item active"><a href="staff">Staffs</a></div>
                        <div class="breadcrumb-item">Staffs Details</div>
                    </div>
                </div>
                <div class="section-body text-center">
                    <h4><?php echo $row_branch['l_name']; ?></h4>
                </div>
                                                ...
                                                <div class="card-body">
                                                    <form class="edit_staff">
                                                        ...
                                                        <div class="text-center">
                                                            <input type="text" name="location_id" value="<?php echo $loc; ?>" hidden>
                                                    ...
                                                    <form class="edit_staff">
                                                        <div class="table-responsive my-table-responsive">
                                                            <table class="table" id="mytable">
                                                                <tbody>
                                                                    <?php
                                                                        $i = 1;
                                                                        $get = "select * from staffs where l_id = '$loc' order by st_name";
                                                        ...
                                                        <div class="text-center">
                                                            <?php
                                                                ...
                                                                {
                                                            ?>
                                                                <input type="text" name="edit_location_id" value="<?php echo $loc; ?>" hidden>
                                                                <input type="text" name="edit_location_total" value="<?php echo $i - 1; ?>" hidden>
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive my-table-responsive">
                                                        <table class="table" id="mytable">
                                                            <tbody>
                                                                <?php
                                                                    $gets = "select * from staffs where l_id = '$loc' order by st_name";
        ...
        $(".edit_staff").submit(function(e)
		{
            ...
            $.ajax({
				...
				success: function(data)
				{
					...
					{
						location.href="staffs_edit?l_id=<?php echo $loc; ?>&l_name=<?php echo $row_branch['l_name']; ?>";
					}
				}
			});
			e.preventDefault();
