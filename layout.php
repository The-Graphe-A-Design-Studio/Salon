        ...
        <div class="main-sidebar">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="services"><a class="nav-link" href="services"><i class="fas fa-list-ol"></i><span>Services</span></a></li>
    ...
    '
        <footer class="main-footer">
            <div class="footer-left">
                Copyright &copy; <script>document.write(new Date().getFullYear());</script> Diva Lounge Spa | Developed by <a href="https://thegraphe.com" target="_blank">The Graphē - A Design Studio</a>
            </div>
        </footer>
    ';
